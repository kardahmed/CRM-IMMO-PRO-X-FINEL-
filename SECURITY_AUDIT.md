...
**Constat** : Next.js App Router utilise `SameSite=Lax` par defaut sur les cookies de session Supabase. Les mutations API sont protegees par le token Supabase Auth (header `Authorization`). Les webhooks sont proteges par signature HMAC.
