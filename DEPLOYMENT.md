...
| `SUPABASE_SERVICE_ROLE_KEY` | Production, Preview | Cle service Supabase (admin) |
...
2. **Authentication > Settings** : configurer les parametres d'email selon les besoins
...
Cela cree :
- 1 Super Admin (identifie par email contact@sensium-x.com)
...
- [ ] Supabase Auth configure pour le domaine custom
